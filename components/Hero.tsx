...
export default function Hero() {
  ...
  const mainImageUrl =
    "https://images.unsplash.com/photo-1680202264255-1a8102a6f97d?q=80&w=2982&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="text-left">
              ...
              >
                ...
                enable adaptive, sensing, and energy-efficient engineering
                solutions.
              </motion.p>
